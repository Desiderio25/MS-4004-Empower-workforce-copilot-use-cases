...
5. After you selected the forward arrow, the **Agent Builder** form appeared for your new agent. At the top of the form are a **Configure** tab and a **Preview** tab.
...
9. Review Copilot's response after updating the instructions. To verify the changes that Copilot made, on the **Configure** tab, scroll down through the **Instructions** section. Verify that Copilot added the new instructions that you requested.
...
14. In the **Knowledge** section, select **+ Add knowledge**, and then select **Attach cloud files** (cloud icon). In the **Pick items** window that appears, locate and select the three files that you downloaded in Step 1.
...
16. You now want to enter several of your own prompts. On the **Configure** tab, scroll down to the **Suggested prompts** section. You should see the three prompts that Copilot added to the agent.  
    ...
    Six suggested prompts are displayed below that are related to popular business-related topics for Trey Research. Review these prompts, select two or three that you like, and then add them to the agent.
...
17. Test several of the suggested prompts by selecting the **Preview** tab. Verify the agent is correctly pulling in data from the knowledge source documents.

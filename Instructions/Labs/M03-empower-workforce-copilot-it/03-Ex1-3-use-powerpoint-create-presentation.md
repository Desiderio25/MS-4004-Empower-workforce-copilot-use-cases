...
1. In your web browser, go to the **Microsoft Copilot** home page, select the **App Launcher** (grid icon), select **More Apps**, and then select **PowerPoint** from the list of available apps.
...
13. Once you're satisfied with the PowerPoint file, rename it and save it to OneDrive.

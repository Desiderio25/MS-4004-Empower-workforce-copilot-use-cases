...
1. In your web browser, go to the **Microsoft Copilot** home page, select the **App Launcher** (grid icon), and then select **More Apps**. From the list of apps, select **PowerPoint**.
...
11. You now want to see whether Copilot can add an image to a slide. Find a slide without an image. Select the slide, and then in the Copilot pane, ask Copilot to generate an image related to the contents of that slide number and then add the image to the slide.

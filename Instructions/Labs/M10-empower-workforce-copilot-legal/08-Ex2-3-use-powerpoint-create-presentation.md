...
1. In your web browser, go to the **Microsoft Copilot** home page, select the **App Launcher** (grid icon), select **More Apps**, and then select **PowerPoint** from the **Apps** menu.
...
4. In the Copilot pane, select the plus **(+)** sign in the prompt field and then select **Add work content** in the drop-down menu. Search for and select the **Lamna Executive Briefing Source.docx** file that you created in Task 1.
...
16. Save your PowerPoint presentation to your OneDrive with an appropriate file name, such as **Lamna Executive Compliance Briefing.pptx**.

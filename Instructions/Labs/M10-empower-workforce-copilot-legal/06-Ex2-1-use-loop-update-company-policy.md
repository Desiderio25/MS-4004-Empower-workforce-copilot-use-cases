...
8. Review Copilot's response. Since it looks like a good starting point, select the **Copy** icon that appears below Copilot's response. To paste this content into the Loop page, select the page below the page heading and press **Ctrl+V**. Review the text that was pasted on the page. Delete any extraneous text that was copied and pasted along with the results (see the start and end of the content).

9. In the Copilot pane, enter the following prompt to have Copilot create an **Access Control** section on the **Draft Policy Sections** page:  
...
10. Review Copilot's response. Since it looks good, copy and paste it into the **Draft Policy Sections** page. Paste it at the end of the page. Delete any extraneous text that was copied and pasted along with the results (see the start and end of the content).
...
17. That concludes the updates to the **Departmental Input & Review** page. Now select the **Task Tracker & Assignments** page in the worksheet menu. For this page, you want Copilot to create a table that contains a list of potential actionable items for each department. Enter the following prompt in the Copilot pane:  
...
20. In the **Executive Briefing Source** page, open the **Copilot** pane and enter the following prompt:  
    ...
    ```prompt
    Combine the content from the following Loop pages in this workspace into a single, structured draft suitable for an executive briefing: Draft Policy Sections and Task Tracker & Assignments. Create a clear outline that includes the following sections: Overview of governance gaps, Updated policy sections (plain language), Cross-department action items for the Legal, IT, and HR departments, 90-day corrective action roadmap, and Metrics and accountability. Write in a professional, concise tone for Legal/Compliance. Don't invent new findings. Use only what's on these pages.
    ```

---
lab:
  title: 'Exercise 1, Task 5: Ask the Regulatory Inquiry Assistant questions related to an audit'
...
1. The **Regulatory Inquiry Assistant** agent should still be open from the prior task. If not, then select the agent on the **Microsoft Copilot** home page.
